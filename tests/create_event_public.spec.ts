...
test.describe('Create Event', () => {
    ...
    test('should create a public event successfully', async ({ page }) => {
        ...
        await createEventPage.selectEventVisibilityPublic();
        await createEventPage.selectEventCategory('Networking');
